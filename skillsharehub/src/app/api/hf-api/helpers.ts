...
export interface FallbackExercises {
  [subject: string]: SubjectExercises;
}

export const FALLBACK_EXERCISES: FallbackExercises = {
  'Matematika': {
    'Kvadratne enačbe': [
      {
...
export function parseGeneratedText(text: string): Exercise {
...
export function getGenericFallback(prompt: string): Exercise {
